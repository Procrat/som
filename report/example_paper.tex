...
\usepackage[nohyperref]{icml2014}
...
\icmltitlerunning{Gridless SOM for better cluster visualization}

\begin{document}

\twocolumn[
\icmltitle{Going off grid:\\
  Introducing a gridless SOM for better cluster visualization}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the icml2014
% package.
\icmlauthor{Stijn Seghers}{stijn.seghers@ugent.be}
\icmladdress{Ghent University}

% You may provide any keywords that you
% find helpful for describing your paper; these are used to populate
% the "keywords" metadata in the PDF but will not be shown in the document
\icmlkeywords{kohonen, self organizing map, som, assymetric, gridless, cluster,
  clustering, high dimensional, visualization}
...
cite your own papers. Also \cite{kohonen1990self}.
